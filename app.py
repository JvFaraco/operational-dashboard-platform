...
# ── Configuracao ─────────────────────────────────────────────────────────────
USERS = ["joao.faraco", "taise.mendes", "sheila.platt", "luciano.hencke"]
...
# Chaves que alimentam dashboards específicos (excluídas da contagem de "O.S")
TIPOS_DASHBOARD = {"bios", "agendadas", "nao_agendadas"}
...
@app.route("/api/base")
def api_base():
    """Retorna os dados da base compartilhada (Contas x EPV)."""
    return jsonify(load_xlsx("base"))
